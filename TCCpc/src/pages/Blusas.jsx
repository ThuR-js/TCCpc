...
const Blusas = () => {
  ...
  // Filtrar apenas blusas/moletons disponíveis
  const blusas = products.filter(product => 
  ...
  return (
    <div className="container">
      ...
      <div className="categories-section">
        <h2 className="section-title">Blusas</h2>
        <p style={{color: '#666', marginBottom: '2rem'}}>
          {blusas.length} blusas disponíveis para doação
        </p>
      </div>
      ...
      {blusas.length === 0 && (
        <div style={{textAlign: 'center', padding: '4rem', color: '#666'}}>
          <h3>Nenhuma blusa disponível no momento</h3>
