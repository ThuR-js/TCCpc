...
const Tenis = () => {
  ...
  // Filtrar apenas tênis disponíveis
  const tenis = products.filter(product => 
    product.type === 'tenis' && product.status === 'available'
  )
  ...
  return (
    <div className="container">
      ...
      <div className="categories-section">
        <h2 className="section-title">Tênis</h2>
        <p style={{color: '#666', marginBottom: '2rem'}}>
          {tenis.length} tênis disponíveis para doação
        </p>
      </div>
