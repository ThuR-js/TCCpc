...
const Shorts = () => {
  ...
  // Filtrar apenas shorts disponíveis
  const shorts = products.filter(product => 
    product.type === 'shorts' && product.status === 'available'
  )
    ...
    <div className="container">
      ...
      <div className="categories-section">
        ...
        <p style={{color: '#666', marginBottom: '2rem'}}>
          {shorts.length} shorts disponíveis para doação
        </p>
      </div>
      ...
      {shorts.length === 0 && (
        <div style={{textAlign: 'center', padding: '4rem', color: '#666'}}>
          <h3>Nenhum shorts disponível no momento</h3>
